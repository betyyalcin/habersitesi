<%@ Page Title="" Language="C#" MasterPageFile="~/kullanici.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="habersitesi._default" %>
...
<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder1">
    <asp:DataList ID="dl_haber" runat="server" Width="690px">
        <ItemTemplate>
            <div>
                <div style="width:690px; margin:0 auto; height:auto;">
                    ...
                    <div style="width: 690px; height: 40px; float: left">
                        ...
                        <div style="width: 650px; height: 40px; float: left; background-image: url('temalar/gri.png'); background-repeat: repeat-x; line-height: 40px;">
                         <a href="haberdetay.aspx?haberİD=<%#Eval("haberİD") %>"><asp:Label ID="Label1" runat="server" Font-Size="20px" Text='<%# Eval("haberBaslik") %>'></asp:Label></a> 
                        </div>
